...
> **Already done on this branch:** defects F1-F8 and P1-P7, and build items 1,
> 2, 3, 4, 5, 6 and 8 below, plus `datasets.json` from item 7. Covered by
> `examples/test_fetch.py`, `examples/test_ingest.py` and
> `examples/test_atlas.py`. Acceptance criteria A1-A7 pass. What remains of
> item 7 is `environment.yml` and the bootstrap scripts, and A8 (a CI job that
> runs every command printed in the README).
